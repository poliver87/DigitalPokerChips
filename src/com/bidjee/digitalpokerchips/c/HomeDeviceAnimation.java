...
public class HomeDeviceAnimation {
	...
	//////////////////// World Scale & Layout ////////////////////
	Vector2 posHostStart=new Vector2();
	Vector2 posHostStop=new Vector2();
	Vector2 posP1Start=new Vector2();
	Vector2 posP1Stop=new Vector2();
	...
	public DPCSprite hostSprite=new DPCSprite();
	public DPCSprite p1Sprite=new DPCSprite();
	public DPCSprite p2Sprite=new DPCSprite();
	public DPCSprite p3Sprite=new DPCSprite();
	public DPCSprite chip1Sprite=new DPCSprite();
	...
	public void setDimensions(float worldWidth,float worldHeight) {
		hostSprite.setDimensions((int)(worldHeight*0.23f),(int)(worldHeight*0.13f));
		p1Sprite.setDimensions((int)(worldHeight*0.125f),(int)(worldHeight*0.07f));
		p2Sprite.setDimensions((int)(worldHeight*0.06f),(int)(worldHeight*0.08f));
		p3Sprite.setDimensions((int)(worldHeight*0.06f),(int)(worldHeight*0.08f));
		...
		chip1Sprite.setDimensions((int)(worldHeight*0.02f),(int)(worldHeight*0.02f));
		chip2Sprite.setDimensions((int)(worldHeight*0.02f),(int)(worldHeight*0.02f));
		chip3Sprite.setDimensions((int)(worldHeight*0.02f),(int)(worldHeight*0.02f));
	...
	public void setPositions(int worldWidth,int worldHeight) {
		...
		p1ClippingRect.set(0,0,p1Sprite.radiusX*2,p1Sprite.radiusY*1.22f);
		p2ClippingRect.set(0,0,p2Sprite.radiusX*1.40f,p2Sprite.radiusY*2);
	...
	public void setAnimationState(int animationState) {
		...
		if (animationState==STATE_HOLDOFF) {
			...
			hostClippingRect.set(hostSprite.x-hostSprite.radiusX*0.84f,hostSprite.y-hostSprite.radiusY*0.72f,hostSprite.radiusX*1.63f,hostSprite.radiusY*1.44f);
